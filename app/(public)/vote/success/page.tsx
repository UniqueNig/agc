...
type VoteSuccessShellProps = {
  verificationState: VerificationState;
  message: string;
  reference: string | null;
};

function VoteSuccessShell({
  verificationState,
  message,
  reference,
}: VoteSuccessShellProps) {
  const showRetry = verificationState !== "success" && Boolean(reference);
  ...
  return (
    <Suspense
      fallback={
        <VoteSuccessShell
          verificationState="verifying"
          message="Your payment was submitted successfully. We are verifying the transaction in the background and your votes will reflect once the payment is confirmed."
          reference={null}
        />
      }
    >
